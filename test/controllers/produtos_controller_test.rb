...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { data_validade: @produto.data_validade, nome: @produto.nome, preco: @produto.preco, quantidade_estoque: @produto.quantidade_estoque } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { data_validade: @produto.data_validade, nome: @produto.nome, preco: @produto.preco, quantidade_estoque: @produto.quantidade_estoque } }
